...
These results show that the univariate and multivariate normal distribution assumptions are unmet. As a result, these violations can be a possible cause of poor fit when testing the psychometric structure of the transactive memory systems scale. In the remainder of 